...
public class VisitorDemoModel {
	 ...
	 */
	private IObjectLoader<IVisitor> loader = new ObjectLoaderPath<IVisitor>((attemptedClassname, params)-> {
			logger.log(LogLevel.ERROR, "Unable to load the given class: "+attemptedClassname+" Returning an error visitor!");
			return new IVisitor() {

				@Override
				public Object caseHostA(HostA host, Object... params) {

					return "["+attemptedClassname+"] Error return for Host A";
				}

				@Override
				public Object caseHostB(HostB host, Object... params) {
					return "["+attemptedClassname+"] Error return for Host B";
				}

				@Override
				public Object caseHostC(HostC host, Object... params) {
					return "["+attemptedClassname+"] Error return for Host C";
				}
